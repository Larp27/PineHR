...
<div class="col-md-12">
  <div class="panel panel-default">
    <div class="panel-heading" style="box-shadow: 0 4px 5px -1px #2468a0;">
      <strong>
        &nbsp;<span><strong style="font-family: 'Glacial Indiffernce'"><i class="fa-solid fa-money-check-dollar fa-xl" style="color: #2468a0;"></i>&nbsp;&nbsp;&nbsp;Payroll Reports</span></strong>
      </strong>
    </div><br>
    ...
    <div class="col-md-7" style="width: 100%">
      <div class="panel panel-default" style="margin-left: 20px; width: 98%; box-shadow: -3px 5px 8px #2468a0, 3px 5px 8px #2468a0; ">
        <div class="panel-heading">
          <strong>
            &nbsp;<span><strong style="font-family: 'Glacial Indiffernce'"><i class="fa-solid fa-calendar-days fa-xl" style="color: #2468a0;"></i>&nbsp;&nbsp;&nbsp;Payroll Date</span></strong>
          </strong>
        ...
        <div class="container-sm mt-4">
          <form action="printreport_payroll.php" method="post">
            ...
            <div class="row">
              <h5 class="fw-bold">PAYROLL REPORT BY DATE</h5>
              <div class="col">
