                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="cert_title" class="fw-bold">Certificate Title</label>
                                    <input type="text" class="form-control" placeholder="Type here" id="cert_title" aria-describedby="addon-wrapping">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <label for="cert_description" class="fw-bold">Certificate Description</label>
                                    <textarea class="form-control" placeholder="Type here" id="cert_description" rows="5" aria-describedby="addon-wrapping"></textarea>
                                </div>
                        ...
                        <div class="col-md-5">
                            <div class="form-group mb-7" style="margin-top: -160px;"> <!-- Adjust margin-top value as needed -->
                                <?php
                                ...
                                ?>
                                <img src="<?php echo $cert_media_path; ?>" id="cert_media_preview" style="width: 400px; height: 200px;" alt="Profile Photo" class="profile-photo">
                            </div>
                        </div>
