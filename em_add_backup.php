      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="form-group mb-3">
              <label for="em_gender" class="fw-bold">Gender</label>
            ...
            <div class="form-group mb-3">
              <label for="bt_id" class="fw-bold">Bloodtype</label>
            ...
            <div class="form-group mb-3">
              <label for="ms_id" class="fw-bold">Marital Status</label>
            ...
            <div class="form-group mb-3">
              <label for="em_email" class="fw-bold">Email</label>
            ...
            <div class="col-4">
              <div class="form-group mb-3">
                <label for="address_id" class="fw-bold">Address</label><Br><br>
                <label for="address_id" class="fw-bold">Barangay</label>
                <select class="form-select" id="address_id" name="address_id" required>
                  <option <?php echo (!isset($address_id)) ? 'selected' : '' ?> disabled>Please Select Here</option>
                  <?php
                  $dep_qry = $conn->query("SELECT * FROM `address` order by barangay, city asc");
                  while ($row = $dep_qry->fetch_assoc()) :
                  ?>
                    <option value="<?php echo $row['address_id'] ?>" <?php echo (isset($address_id) && $address_id == $row['address_id']) ? 'selected' : '' ?>>
                      <?php echo $row['barangay'] ?></option>
                  <?php endwhile; ?>
                </select>
                <br>

                <label for="address_id" class="fw-bold">City</label>
                <select class="form-select" id="address_id" name="address_id" required>
                  <option <?php echo (!isset($address_id)) ? 'selected' : '' ?> disabled>Please Select Here</option>
                  <?php
                  $dep_qry = $conn->query("SELECT * FROM `address` order by barangay, city asc");
              ...
              <div class="form-group mb-3">
                <label for="edu_id" class="fw-bold">Educational Attainment</label>
              ...
              <div class="form-group mb-3">
                <label for="dep_id" class="fw-bold">Department</label>
              ...
              <div class="form-group mb-3">
                <label for="des_id" class="fw-bold">Designation</label>
              ...
              <div class="form-group mb-3">
                <label for="es_id" class="fw-bold">Employment Status</label>
              ...
              <div class="form-group mb-3">
                <label for="user_id" class="fw-bold">User Role</label>
              ...
              <div class="form-group mb-3">
                <div class="row">
                  ...
                  while ($leave_type = $leave_types_query->fetch_assoc()) {
                    ...
                    echo '<input type="checkbox" id="leave_type_' . $leave_type['lt_id'] . '" name="leave_type_names[]" value="' . $leave_type['lt_name'] . '" class="form-check-input">';
