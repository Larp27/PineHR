            ...
            <table class="table" id="example">
              ...
              <thead class="" style="background-color: rgb(255, 206, 46)">
                <tr>
                  ...
                  <th class="text-center p-2">Date Acquired</th>
                  <th class="text-center p-2">Date Added</th>
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                $r_cert_date = $row['cert_date'];
                $r_cert_uploaded = $row['cert_uploaded'];
                ...
                "<tr> 
                  ...
                  <td class='text-center p-3'><img src='../PINEHR/" . substr($row['cert_media'], 3) . "' style='width:60%; height: 80px; border-radius: 50%; border: 2px solid #2468a0;'></td>
              ...
              ?>
                  <td class='text-center p-1'>
                    <div class="col-auto d-flex justify-content-center m-2">
                      <a href="Certificate/deleteCert.php?cert_id=<?php echo $row['cert_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this Certificate Data?')"><i class="fas fa-trash"></i> Delete </a>
                    </div>
                  </td>
                </tr>
              <?php
