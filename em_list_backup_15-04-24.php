            ...
            <div class="dash_content_main">
              ...
              <table id="example" class="table">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  $r_em_profile_pic = $row['em_profile_pic'];
                  $available_leave_types = $row['available_leave_types'];

                  echo "<tr> 
              <td class='text-center p-3'> $r_em_id </td>
              <td class='text-center p-3'><img src=\"$r_em_profile_pic\" style=\"max-width:100px;max-height:100px;\"></td>
              <td class='text-left p-3'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              &nbsp; $r_last_name, $r_first_name </td>
              

              <td class='text-left p-3'> <strong>&nbsp;&nbsp;Department</strong>: $r_dep_name <br> <strong>&nbsp;&nbsp;Designation</strong>: $r_des_name </td>";
