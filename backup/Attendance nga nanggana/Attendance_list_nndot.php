...
<html lang="en" dir="ltr">
    <head>
    <meta charset="UTF-8">
    <title>Attendance List| PINE HR</title>
...
<div class="col-md-12">
    ...
    <div class="panel panel-default" style="margin-left: 20px; width: 98%; box-shadow: -3px 5px 8px #2468a0, 3px 5px 8px #2468a0; ">
      <div class="panel-heading" >
        <strong>
          &nbsp;<span><strong style="font-family: 'Glacial Indiffernce'"><i class="fa-solid fa-table-list fa-xl" style="color: #2468a0;"></i>&nbsp;&nbsp;&nbsp;Attendance List</span></strong>
       </strong>
    ...
    <tr>
      ...
      <th class="text-center p-1">Working Hour</th>
			...
			<tr>
				...
				<td class="text-center p-1"> <?php echo $row["em_name"]; ?> </td>
				<td class="text-center p-1"> <?php echo $row["att_date"]; ?> </td>
				<td class="text-center p-1"> <?php echo $row["att_s_in"]; ?> </td>
                <td class="text-center p-1"> <?php echo $row["att_s_out"]; ?> </td>
                <td class="text-center p-1"> <?php echo $row["att_total_hr"]; ?> </td>
			</tr>
			<?php endforeach; ?>
		</table>
		<?php
