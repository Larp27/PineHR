                ...
                <div class="card-box">
                  <div class="text-dark">
                    ...
                    <div class="icon-label">
                      ...
                      <h5><strong>Leave Application</strong></h5>
                    </div>
                  </div>
                </div>
              </a>
                ...
                <div class="card-box">
                  <div class="text-dark">
                    ...
                    <div class="icon-label">
                      ...
                      <h5><strong>Accepted Leave Application</strong></h5>
                    </div>
                  </div>
                </div>
              </a>
                ...
                <div class="card-box">
                  <div class="text-dark">
                    ...
                    <div class="icon-label">
                      ...
                      <h5><strong>Pending Leave Application</strong></h5>
                    </div>
                  </div>
                </div>
              </a>
                ...
                <div class="card-box">
                  <div class="text-dark">
                    ...
                    <div class="icon-label">
                      ...
                      <h5><strong>Declined Leave Application</strong></h5>
                    </div>
                  </div>
                </div>
              </a>
                ...
                <div class="card-box">
                  <div class="text-dark">
                    ...
                    <div class="icon-label">
                      ...
                      <h5><strong>Total Employees</strong></h5>
                    </div>
                  </div>
                </div>
              </a>
