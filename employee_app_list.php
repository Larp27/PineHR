        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
              ...
              <div class="panel panel-default">
                <div class="panel panel-default" style="margin-left: 20px; width: 98%; box-shadow: -3px 5px 8px #2468a0, 3px 5px 8px #2468a0; ">
                  <div class="panel-heading">
                    ...
                    ?>
                      <table class="table table-hover" id="acceptedTable">
            ...
            <div class="panel panel-default">
              <div class="panel panel-default" style="margin-left: 20px; width: 98%; box-shadow: -3px 5px 8px #2468a0, 3px 5px 8px #2468a0; ">
                <div class="panel-heading">
                  <strong style="font-family: 'Glacial Indiffernce'"><i class="fa-solid fa-table-list fa-xl" style="color: #2468a0;"></i>&nbsp;&nbsp;Leave Application List (Pending)</strong>
                  <?php
                  $query = "SELECT la.*, lt.*, e.first_name, e.last_name
                FROM `leave_application` la 
                INNER JOIN `leave_type` lt ON la.lt_id = lt.lt_id 
                INNER JOIN `employee` e ON la.em_id = e.em_id
                WHERE la.em_id = $em_id AND la.la_status = 'Pending'";
                  $result = mysqli_query($conn, $query);
                  if (mysqli_num_rows($result) > 0) {
                  ?>
