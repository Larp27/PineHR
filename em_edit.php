    ...
    <div class="card card-outline card-primary m-3 mb-4">
      <div class="card-header">
        <div class="panel-heading" style="padding: 2px !important;">
          <strong>
            &nbsp;<span><strong style="font-family: 'Glacial Indifference'">Edit Employee</span></strong>
          </strong>
        </div>
      </div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control" placeholder="" id="em_income" name="em_income" aria-describedby="addon-wrapping" required value="<?php echo isset($em_income) ? $em_income : ''; ?>">
            </div>
              <div class="form-group mb-3">
    ...
    <div>
      <div class="card card-outline card-primary m-3">
        <div class="card-header">
          <div class="panel-heading" style="padding: 2px !important;">
            <strong>
              &nbsp;<span><strong style="font-family: 'Glacial Indifference'"><i class="fa-solid fa-plus fa-xl" style="color: #2468a0;"></i>&nbsp;&nbsp;&nbsp;Leave Types Permission</span></strong>
            </strong>
          </div>
        </div>
